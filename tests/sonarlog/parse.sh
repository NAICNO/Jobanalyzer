...
output=$($SONALYZE parse --fmt=csv,user,rolledup,pid,job,time,gpus,cputime_sec -- parse-data.csv)
CHECK parse_file \
...
output=$($SONALYZE parse --fmt=csv,user,rolledup,pid,job,time,gpus,cputime_sec -- parse-data1.csv parse-data2.csv)
