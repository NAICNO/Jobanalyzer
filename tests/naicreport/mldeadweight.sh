...
output=$($NAICREPORT ml-deadweight --from 2023-09-26 --state-file $statefile --summary -- deadweight1.csv | sort)
...
output=$($NAICREPORT ml-deadweight --from 2023-09-26 --state-file $statefile --summary -- deadweight2.csv | sort)
