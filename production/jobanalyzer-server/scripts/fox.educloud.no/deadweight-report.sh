...
$sonar_dir/naicreport deadweight -data-path $state_dir -from 4w > $report_dir/fox-deadweight-report.txt
...
$sonar_dir/naicreport deadweight -data-path $state_dir -from 4w -json > $report_dir/fox-deadweight-report.json
