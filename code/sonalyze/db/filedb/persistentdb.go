...
func NewPersistentCluster(dataDir string, meta types.Context) *PersistentCluster {
	...
	return &PersistentCluster{
		...
		sysinfoNodeDataMethods:   NewSysinfoFileMethods(SysinfoFileKindNodeData),
		sysinfoCardDataMethods:   NewSysinfoFileMethods(SysinfoFileKindCardData),
		sacctMethods:             NewSacctFileMethods(),
		cluzterAttributesMethods: NewCluzterFileMethods(CluzterFileKindAttributeData),
		cluzterPartitionsMethods: NewCluzterFileMethods(CluzterFileKindPartitionData),
...
func (pc *PersistentCluster) SampleFilenames(
	...
	return pc.findFilenames(filter, &pc.sampleFiles)
}
...
func (pc *PersistentCluster) SysinfoFilenames(
	...
	return pc.findFilenames(filter, &pc.sysinfoFiles)
}
...
func (pc *PersistentCluster) SacctFilenames(
	...
	return pc.findFilenames(filter, &pc.sacctFiles)
}
...
func (pc *PersistentCluster) CluzterFilenames(
	...
	return pc.findFilenames(filter, &pc.cluzterFiles)
}
...
func FilenameGlobber(h Multihost, globs []string) *hostglob.HostGlobber {
