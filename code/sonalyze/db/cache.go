...
func CacheInit(cacheSize int64) {
	...
	Log.Infof("Initial budget %d", cacheSize)
...
// priority queue, with its O(log n) extraction cost, and n will be in the range 17-18 here), and
// 2-random LRU beats plain random by a good margin.  And 2-random is simple.)
