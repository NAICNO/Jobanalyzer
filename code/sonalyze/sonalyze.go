...
func sonalyze() error {
	...
	case "help", "-h":
		...
		fmt.Fprintf(out, "  slurm    - print information extracted from slurm data\n")
...
// TODO: Possibly top and slurm can be handled together, they are instances of AnalysisCommand
...
func (_ *standardCommandLineHandler) HandleCommand(anyCmd Command, stdin io.Reader, stdout, stderr io.Writer) error {
	...
	case *slurm.SlurmCommand:
		return cmd.Slurm(stdin, stdout, stderr)
