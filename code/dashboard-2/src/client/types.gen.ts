...
export type AllocTres = {
     ...
     * Gpu
     *
     * The reserved number of gpus
     */
    gpu?: number;
    /**
     * Node
     *
     * The involved number of nodes
     */
    node?: number;
    /**
     * Billing
 ...
 */
export type JobNodeSampleProcessGpuTimeseriesResponse = {
    /**
     * Job
     *
     * Job ID
 ...
 * JobQueryResultItem
 */
export type JobQueryResultItem = {
    /**
     * Job
     */
    job: string;
...
export type JobResponse = {
     ...
     * Gres Detail
     *
     * DEPRECATED: List of general resources details - use requested_resources and allocated_resources
     */
    gres_detail?: Array<string> | null;
    /**
     * Requested Resources
     *
     * List of general resources requested
     */
    requested_resources?: string | null;
    /**
     * Allocated Resources
     *
     * List of general resources allocated
     */
     ...
     *
     * Requested memory in kilobytes per node
     */
     ...
     *
     * DEPRECATED: Minimum required CPUs per node, use requested_cpus
     */
    minimum_cpus_per_node?: number | null;
    /**
     * Used Gpu Uuids
     *
...
export type NodeInfoResponse = {
     ...
     * Topo Text
     *
     * The architecture topography (lstopo) as text
     */
    topo_text: string | null;
    /**
     * Cards
     *
     * List of GPUs
    ...
    partitions?: Array<string>;
    /**
     * Allocation of traceable resources
     */
 ...
 */
export type SystemProcessTimeseriesResponse = {
    /**
     * Job
     *
     * Job ID
...
export type GetClearCacheResponses = {
    /**
     * Successful Response
     */
    200: unknown;
