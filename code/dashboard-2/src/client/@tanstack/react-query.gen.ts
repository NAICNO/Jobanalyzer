...
export const getClusterByClusterNodesDiskstatsTimeseriesQueryKey = (options: Options<GetClusterByClusterNodesDiskstatsTimeseriesData>) => createQueryKey('getClusterByClusterNodesDiskstatsTimeseries', options)

/**
 * Get timeseries data of GPU samples for all nodes in a given cluster
 */
export const getClusterByClusterNodesDiskstatsTimeseriesOptions = (options: Options<GetClusterByClusterNodesDiskstatsTimeseriesData>) => queryOptions<GetClusterByClusterNodesDiskstatsTimeseriesResponse, AxiosError<GetClusterByClusterNodesDiskstatsTimeseriesError>, GetClusterByClusterNodesDiskstatsTimeseriesResponse, ReturnType<typeof getClusterByClusterNodesDiskstatsTimeseriesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getClusterByClusterNodesDiskstatsTimeseries({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getClusterByClusterNodesDiskstatsTimeseriesQueryKey(options)
})

export const getClusterByClusterNodesByNodenameDiskstatsTimeseriesQueryKey = (options: Options<GetClusterByClusterNodesByNodenameDiskstatsTimeseriesData>) => createQueryKey('getClusterByClusterNodesByNodenameDiskstatsTimeseries', options)

/**
 * Get **node**-specific timeseries data of DiskStat samples
 */
export const getClusterByClusterNodesByNodenameDiskstatsTimeseriesOptions = (options: Options<GetClusterByClusterNodesByNodenameDiskstatsTimeseriesData>) => queryOptions<GetClusterByClusterNodesByNodenameDiskstatsTimeseriesResponse, AxiosError<GetClusterByClusterNodesByNodenameDiskstatsTimeseriesError>, GetClusterByClusterNodesByNodenameDiskstatsTimeseriesResponse, ReturnType<typeof getClusterByClusterNodesByNodenameDiskstatsTimeseriesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getClusterByClusterNodesByNodenameDiskstatsTimeseries({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getClusterByClusterNodesByNodenameDiskstatsTimeseriesQueryKey(options)
})
...
export const getClusterByClusterJobsByJobIdProcessTreeQueryKey = (options: Options<GetClusterByClusterJobsByJobIdProcessTreeData>) => createQueryKey('getClusterByClusterJobsByJobIdProcessTree', options)

/**
 * Get **job**-specific process (cpu/memory) timeseries data
 *
 ...
 * To relate to non-SLURM jobs, provide the epoch as parameter to the query.
 */
export const getClusterByClusterJobsByJobIdProcessTreeOptions = (options: Options<GetClusterByClusterJobsByJobIdProcessTreeData>) => queryOptions<GetClusterByClusterJobsByJobIdProcessTreeResponse, AxiosError<GetClusterByClusterJobsByJobIdProcessTreeError>, GetClusterByClusterJobsByJobIdProcessTreeResponse, ReturnType<typeof getClusterByClusterJobsByJobIdProcessTreeQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getClusterByClusterJobsByJobIdProcessTree({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
  ...
  queryKey: getClusterByClusterJobsByJobIdProcessTreeQueryKey(options)
})
...
export const getClusterByClusterQueryJobsPagesQueryKey = (options: Options<GetClusterByClusterQueryJobsPagesData>) => createQueryKey('getClusterByClusterQueryJobsPages', options)

/**
 * Provides a generic job query interface
 */
export const getClusterByClusterQueryJobsPagesOptions = (options: Options<GetClusterByClusterQueryJobsPagesData>) => queryOptions<GetClusterByClusterQueryJobsPagesResponse, AxiosError<GetClusterByClusterQueryJobsPagesError>, GetClusterByClusterQueryJobsPagesResponse, ReturnType<typeof getClusterByClusterQueryJobsPagesQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
    const { data } = await getClusterByClusterQueryJobsPages({
      ...options,
      ...queryKey[0],
      signal,
      throwOnError: true
 ...
 * Provides a generic job query interface
 */
export const getClusterByClusterQueryJobsPagesInfiniteOptions = (options: Options<GetClusterByClusterQueryJobsPagesData>) => infiniteQueryOptions<GetClusterByClusterQueryJobsPagesResponse, AxiosError<GetClusterByClusterQueryJobsPagesError>, InfiniteData<GetClusterByClusterQueryJobsPagesResponse>, QueryKey<Options<GetClusterByClusterQueryJobsPagesData>>, number | Pick<QueryKey<Options<GetClusterByClusterQueryJobsPagesData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
  {
    queryFn: async ({ pageParam, queryKey, signal }) => {
      // @ts-ignore
      const page: Pick<QueryKey<Options<GetClusterByClusterQueryJobsPagesData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
        query: {
          page: pageParam
        }
      }
    ...
    queryKey: getClusterByClusterQueryJobsPagesInfiniteQueryKey(options)
  })
 ...
 * Get user settings
 */
export const getUserSettingsOptions = (options?: Options<GetUserSettingsData>) => queryOptions<unknown, AxiosError<GetUserSettingsError>, unknown, ReturnType<typeof getUserSettingsQueryKey>>({
  queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const postUserSettingsMutation = (options?: Partial<Options<PostUserSettingsData>>): UseMutationOptions<unknown, AxiosError<PostUserSettingsError>, Options<PostUserSettingsData>> => {
  const mutationOptions: UseMutationOptions<unknown, AxiosError<PostUserSettingsError>, Options<PostUserSettingsData>> = {
    mutationFn: async (fnOptions) => {
      const { data } = await postUserSettings({
        ...options,
        ...fnOptions,
        throwOnError: true
      })
 ...
 * Post / Set the user settings
 */
export const putUserSettingsMutation = (options?: Partial<Options<PutUserSettingsData>>): UseMutationOptions<unknown, AxiosError<PutUserSettingsError>, Options<PutUserSettingsData>> => {
  const mutationOptions: UseMutationOptions<unknown, AxiosError<PutUserSettingsError>, Options<PutUserSettingsData>> = {
    mutationFn: async (fnOptions) => {
