...
import { useJobDetails, useJobReport } from '../hooks/useJobQueries'
...
const PerformanceMetricsTab = lazy(() => import('../components/PerformanceMetricsTab').then(m => ({ default: m.PerformanceMetricsTab })))
const ResourceTimelineTab = lazy(() => import('../components/ResourceTimelineTab').then(m => ({ default: m.ResourceTimelineTab })))
const GpuPerformanceTab = lazy(() => import('../components/GpuPerformanceTab').then(m => ({ default: m.GpuPerformanceTab })))
const ProcessTreeTab = lazy(() => import('../components/ProcessTreeTab').then(m => ({ default: m.ProcessTreeTab })))
