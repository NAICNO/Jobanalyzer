...
import { PartitionSummary } from '../components/PartitionSummary'
import { PartitionQueueOverview } from '../components/PartitionQueueOverview'
import { PartitionNodes } from '../components/PartitionNodes'
import { PartitionGpus } from '../components/PartitionGpus'
...
export const PartitionsPage = () => {
  ...
  return (
    <VStack h="calc(100vh - 85px)" gap={0} align="stretch" overflow="hidden">
      ...
      <Box position="relative" flex="1" minH="0">
        ...
        >
          <Splitter.Panel id="left">
            <VStack p={4} gap={4} h="full" overflow="hidden">
              {isLoading && (
              ...
              {!isLoading && !isError && partitions.length > 0 && (
                ...
                >
                  ...
                  <Listbox.Content css={{ flex: 1, maxHeight: 'unset' }}>
