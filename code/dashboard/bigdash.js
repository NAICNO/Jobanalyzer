...
builtinOperation["busy"] = compileQuery("cpu-busy or gpu-busy or mem-busy or gpumem-busy", knownFields, builtinOperation)
builtinOperation["Busy"] = compileQuery("Cpu-busy or Gpu-busy or Mem-busy or Gpumem-busy", knownFields, builtinOperation)
builtinOperation["idle"] = compileQuery("cpu-idle and mem-idle and (~gpu* or (gpu% < 50 and gpumem% < 50))", knownFields, builtinOperation)
builtinOperation["Idle"] = compileQuery("Cpu-idle and Mem-idle and (~gpu* or (Gpu% < 50 and Gpumem% < 50))", knownFields, builtinOperation)
